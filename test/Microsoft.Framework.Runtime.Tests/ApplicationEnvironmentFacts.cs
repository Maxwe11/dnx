...
namespace Microsoft.Framework.Runtime.Tests
{
    public class ApplicationEnvironmentFacts
    {
        ...
        {
            var appEnv = new ApplicationEnvironment(null, null, null);
        ...
        {
            var appEnv1 = new ApplicationEnvironment(null, null, null);
            var appEnv2 = new ApplicationEnvironment(null, null, null);
            var obj = new object();
